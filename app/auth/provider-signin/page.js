...
export default function ProviderSignInPage() {
  ...
  if (status === 'processing') {
    return (
      <div className="min-h-screen flex items-center justify-center" data-testid="auth-provider-processing">
  ...
  if (status === 'error') {
    return (
      <div className="min-h-screen flex items-center justify-center" data-testid="auth-provider-error">
        <div className="text-center">
          ...
          <button 
            ...
            data-testid="auth-provider-error-home"
          >
            Return to Home
          </button>
        </div>
  ...
  if (status === 'success') {
    return (
      <div className="min-h-screen flex items-center justify-center" data-testid="auth-provider-success">
        <div className="text-center">
